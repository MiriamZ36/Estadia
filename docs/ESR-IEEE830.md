...
Este documento concentra la información necesaria para redactar la **Especificación de Requisitos de Software (ERS/ESR)** conforme a **IEEE 830** del proyecto **Torneo Fut / LigaSmart**.
